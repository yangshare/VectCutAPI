...
ERROR_CODES = {
    ...
    "T_TOO_LARGE": "模板文件过大",
    "T_DRAFT_CONTENT_TOO_LARGE": "draft_content.json 文件过大",
    "T_INVALID_DRAFT_CONTENT": "draft_content.json 格式无效",
    "T_ENCRYPTED_DRAFT_UNSUPPORTED": "服务端未配置剪映解密 DLL",
    "T_DECRYPT_FAILED": "draft_content.json 解密失败",
    ...
    "S_INVALID_LOCATOR": "槽位 locator 无法定位",
